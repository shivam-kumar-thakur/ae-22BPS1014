...
import { newAdminRegister,bookingsTotal,vehicleDetailsFinder, newDriverRegister, newVehicleRegister ,assignVehicleDirectly,viewDriverByInfo,viewDriverByLocation ,assignVehicleOpen} from "../controllers/admin.controller.js";
...
adminRouter.route("/vehicle-details").post(verifyJWT,vehicleDetailsFinder);
adminRouter.route("/bookings-total").get(verifyJWT,bookingsTotal);
